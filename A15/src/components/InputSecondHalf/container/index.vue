...
import InputSecondHalfPresentational from '@/components/InputFirstHalf/presentational/index.vue'
import { useHalfInput } from '@/components/composables/useHalfInput'

defineOptions({
  name: 'InputSecondHalfContainer',
})
interface Props {
  minLength: number
  maxLength: number
